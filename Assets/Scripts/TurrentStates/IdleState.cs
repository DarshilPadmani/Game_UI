...
public class IdleState : TurrentState
{
    public override void Enter(Turrent parent)
    {
        base.Enter(parent);
    ...
    public override void Update()
    {
        ...
        {
            parent.Rotator.rotation = Quaternion.RotateTowards(parent.Rotator.rotation, parent.DefaultRotation,
